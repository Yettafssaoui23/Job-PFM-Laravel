            ...
            <div class="row">
                <div class="col-md-12 mb-5 mb-md-0" data-aos="fade-up" data-aos-delay="100">
                        ...
                        @foreach ($jobs as $job)
                            <a href="{{ route('jobs.show', [$job->id, $job->slug]) }}"
                                ...
                                <div class="company-logo blank-logo text-center text-md-left pl-3">
                                    ...
                                    @else
                                        <img src="{{ asset('avatar/man.jpg') }}" alt="Image"
                                            class="img-fluid mx-auto">
                                    @endif
                                </div>
                    ...
                    <div class="col-md-12 text-center mt-5">
                        <a href="{{ route('alljobs') }}" class="btn btn-info rounded py-3 px-5"><span
                                class="icon-plus-circle"></span> Afficher plus d'emplois</a>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-md-6 text-center" data-aos="fade">
                    ...
                    <p><a href="/register" class="btn btn-info py-3 px-4"><i class="fa fa-users"
                                style="color: #fff;">&nbsp;</i> Espace Demandeur</a> <a
                            href="{{ route('employer.register') }}" class="btn btn-info py-3 px-4"><i
                                class="fa fa-building" style="color: #fff;">&nbsp;</i> Espace Employeur</a></p>
