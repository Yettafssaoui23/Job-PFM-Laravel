...
<div class="container">
    ...
    <div>
      <a href="{{route('alljobs')}}">  <button class="btn btn-primary btn-lg" style="width: 100%;">Parcourir tous les Emplois</button></a>
    </div>
    <br><br>
...
<div class="col-md-3">
    <div class="card" style="width: 18rem;">
      ...
      <div class="card-body">
        ...
        <a href="{{route('company.index',[$company->id,$company->slug])}}" class="btn btn-outline-info ">Visiter Entreprise</a>
      </div>
    </div>
</div>
@endforeach
