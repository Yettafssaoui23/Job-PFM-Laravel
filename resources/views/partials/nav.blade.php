            ...
            <div class="site-navbar bg-light">
                <div class="py-1">
                    <div class="row align-items-center">
                        <div class="col-2">
                            <h2 class="mb-0 site-logo"><a href="/">MI<strong class="font-weight-bold">BY</strong>
                                </a></h2>
                        </div>
                        <div class="col-10">
                            <nav class="site-navigation text-right" role="navigation">
                                <div class="container">
                                    ...
                                    <ul class="site-menu js-clone-nav d-none d-lg-block">
                                        ...
                                        <li>
                                            @if (!Auth::check())
                                                <button type="button" class="btn btn-info text-white py-3 px-4 rounded"
                                                    data-toggle="modal" data-target="#exampleModal">
                                                    <i class="fa fa-sign-in" style="color: #fff;">&nbsp;</i> Se
                                                    Connecter
                                                </button>
                                            @else
                                                <a href="{{ route('logout') }}"
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <input id="email" type="email" placeholder="Veuillez saisir votre Adresse E-mail"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <input id="password" placeholder="Veuillez saisir votre Mot de Passe" type="password"
